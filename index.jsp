<%-- 
    Document   : index
    Created on : Jul 6, 2020, 5:11:40 PM
    Author     : user
--%>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <img src="/public/assets/images/anya-geraldine.jpg" width="180" height="150" class="img-responsive"/>
                                        <p class="pt-3">Mantan, adalah kata paling menyeramkan di dunia percintaan [...]</p>
                                        <a href="./views/details.jsp" class="btn btn-sm btn-primary">Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <img src="./public/assets/images/chelsea-islan.jpg" width="180" height="150" class="img-responsive"/>
                                        <p class="pt-3">Mantan, adalah kata paling menyeramkan di dunia percintaan [...]</p>
                                        <a href="./views/details.jsp" class="btn btn-sm btn-primary">Selengkapnya</a>
                                    </div>
                                </div>
